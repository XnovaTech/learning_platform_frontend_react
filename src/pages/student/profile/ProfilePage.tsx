...
export default function ProfilePage() {
    ...
    return (
        <>
            <div className="mt-10 ">
               <div className="max-w-5xl w-full mx-auto bg-white/50 rounded-2xl shadow-xl backdrop-blur-md p-8">
                <div className=" flex flex-col md:flex-row items-center md:items-start gap-12">
                    ...
                    <div className=" flex-1 text-center md:text-left">
                        <div className=" md:flex justify-between items-center mt-6">
                            <div>
                                <p className=" text-gray-500 text-xl md:text-3xl font-medium">
                                    My Profile
                                </p>
                ...
                <div className="max-w-5xl mt-6 w-full mx-auto bg-white/50 rounded-2xl shadow-xl backdrop-blur-md p-8">
