  ...
  return (
    <div className="min-h-screen   flex items-center justify-center p-4">
      <div className="flex flex-col md:flex-row max-w-4xl w-full rounded-xl overflow-hidden shadow-2xl">
        <div className="md:w-1/2 bg-primary/60 p-5 md:p-8 flex flex-col justify-center items-center text-white space-y-4">
          <div className="relative z-10 text-center space-y-3 md:space-y-6">
            <h1 className="text-xl md:text-3xl font-bold tracking-wide drop-shadow-2xl">
              THE CRYSTAL <br /> LEARNING HUB
            </h1>
            <Lottie animationData={welcome} loop={true} className=" w-6/12 md:w-8/12 mx-auto" />
            <p className="text-md md:text-lg font-light ">Sign in to continue your learning journey.</p>
          </div>
        </div>
