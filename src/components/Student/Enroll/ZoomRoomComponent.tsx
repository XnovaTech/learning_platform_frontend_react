    ...
    <div className=" drop-shadow-2xl backdrop-blur-lg bg-white/50 dark:bg-slate-900/80 rounded-2xl p-6 md:p-8 text-center">
      {zoomLink ? (
        <>
          ...
          <a href={zoomLink} target="_blank" rel="noopener noreferrer" className="inline-block px-7 py-3 bg-sky-600 text-white font-semibold rounded-xl hover:bg-sky-700 transition-colors">
            Join Zoom Class
          </a>
        </>
      ) : (
